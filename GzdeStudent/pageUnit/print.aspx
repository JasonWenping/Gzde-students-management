<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print.aspx.cs" Inherits="GzdeStudent.pageUnit.print" %>
...
<table>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label10" runat="server" Text="学校:"></asp:Label>
                            <asp:Label ID="UniversityLabel" runat="server" Text="Lable"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="Label14" runat="server" Text="专业:"></asp:Label>
                            <asp:Label ID="MajorLabel"
                                runat="server" Text="Label"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="Label15" runat="server" Text="年级:"></asp:Label>
...
<input name="button1" type="button" value="打印页面" onclick="javascript:window.print();" />
</div>
</div>
    </div>
    </form>
